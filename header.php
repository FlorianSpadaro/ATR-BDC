...
<<<<<<< HEAD
                        <li><a href="habilitationElectrique.php" id="formulaireHabilElec"><span class="glyphicon glyphicon-education"></span> Habilitations H0-B0</span></a></li>
=======
                        <li><a href="habilitationElectrique.php" id="formulaireHabilElec"><span class="glyphicon glyphicon-education"></span> Habilitations H0-B0</a></li>
>>>>>>> 7b32c04a08bb9a959fa76a812554a414a704f643
                        <?php if(isset($_SESSION["niveau"]) && $_SESSION["niveau"]->niveau == 3){ ?><li><a href="listeHabilitationElectrique.php"><span class="glyphicon glyphicon-education"></span> Liste des Habilitations H0-B0</a></li> <?php } ?>
